<template>
    <div
        class="bg-gray-800 text-white p-4 rounded-2xl shadow-md w-full max-w-sm relative transition-colors duration-150"
        :class="{ 'bg-red-700/60': overloaded }"
    >
        <h2 class="text-xl font-semibold mb-4">🎚️ Master Output</h2>
...
const getMeterColor = (value) => {
    if (value > 220) return '#f87171'
    if (value > 140) return '#facc15'
    return '#4ade80'
}
</script>
