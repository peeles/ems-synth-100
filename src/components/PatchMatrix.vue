<template>
    <div
        class="relative h-full w-full overflow-auto bg-gray-900 text-green-200 border-l border-gray-700 p-4"
    >
        <button
        ...
        <table class="table-auto border-collapse text-sm" dir="ltr">
            <thead>
            <tr>
